                        ...
                        <div class="modal-body">
                            <form method="post" id="productForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="folioNum" id="folioNum" class="form-control rounded-0" required />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="placeid" id="placeid" class="form-select rounded-0" required>
                                        <option value="">Select Place </option>
                                        <?php echo $inventory->placeDropdownList();?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Active</label>
                                    <input type="text" name="active" id="active" class="form-control rounded-0" required pattern="[+-]?([0-9]*[.])?[0-9]+" />
                                </div>
                                <div class="form-group">
                                    <label>Inactive</label>
                                    <input type="text" name="inactive" id="inactive" class="form-control rounded-0" required pattern="[+-]?([0-9]*[.])?[0-9]+" />
                                </div>
                                <div class="form-group">
