	...
	<div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav menus">		
				...
				<li class="nav-item"><a class="nav-link" href="customer.php" id="customer_menu">Authorized</a></li>
				<li class="nav-item"><a class="nav-link" href="category.php" id="category_menu">Category</a></li>
				<li class="nav-item"><a class="nav-link" href="product.php" id="product_menu">Asset</a></li>
				<!--
				<li class="nav-item"><a class="nav-link" href="place.php" id="product_menu">Place</a></li>
-->
			</ul>
		</div>
